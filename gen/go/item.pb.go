...
var file_item_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x04, 0x75, 0x75, 0x69, 0x64, 0x32, 0xca, 0x01, 0x0a, 0x0b, 0x49, 0x74, 0x65, 0x6d,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3e, 0x0a, 0x09, 0x50, 0x6f, 0x73, 0x74, 0x49, 0x74, 0x65, 0x6d,
...
var file_item_proto_depIdxs = []int32{
	...
	5, // 7: example.ItemService.PostItems:output_type -> google.protobuf.Empty
...
type ItemServiceClient interface {
	...
	PostItems(ctx context.Context, in *PostItemsRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *itemServiceClient) PostItems(ctx context.Context, in *PostItemsRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type ItemServiceServer interface {
	...
	PostItems(context.Context, *PostItemsRequest) (*empty.Empty, error)
}
...
func (*UnimplementedItemServiceServer) PostItems(context.Context, *PostItemsRequest) (*empty.Empty, error) {
